...
exports.UnifiedAudioListener = exports.UnifiedAudioSystem = void 0;
exports.createAudioSystem = createAudioSystem;
exports.createAudioListener = createAudioListener;
...
class UnifiedAudioSystem {
    ...
    async connectToServer() {
        return new Promise((resolve) => {
            try {
                this.socket = (0, socket_io_client_1.io)('http://localhost:3001', {
    ...
    setupSocketHandlers() {
        ...
        this.socket.on('audio-source-added', (data) => {
            console.log('🎤 Audio source added:', data);
        });
        this.socket.on('audio-source-updated', (data) => {
            console.log('🎛️ Audio source updated:', data);
        });
        this.socket.on('audio-source-removed', (data) => {
            console.log('🔇 Audio source removed:', data);
        });
        this.socket.on('call-accepted', (data) => {
            this.handleIncomingCall(data);
        });
        this.socket.on('broadcast-stats', (stats) => {
    ...
    async addAudioSource(sourceConfig) {
        try {
            ...
            let stream = sourceConfig.stream;
    ...
    async connectSourceStream(sourceId, stream) {
    ...
    async startAudioStreaming() {
        if (!this.destinationStream || !this.socket)
            return;
        try {
    ...
    async getCallerAudioStream(callId) {
...
exports.UnifiedAudioSystem = UnifiedAudioSystem;
// Audio Listener Class for receiving broadcasts
class UnifiedAudioListener {
    ...
    async playAudioData(audioData) {
        if (!this.audioContext || !audioData.audio)
            return;
        try {
...
exports.UnifiedAudioListener = UnifiedAudioListener;
// Helper function to create a configured audio system
function createAudioSystem(broadcastId) {
...
function createAudioListener(broadcastId) {
    return new UnifiedAudioListener(broadcastId);
}
//# sourceMappingURL=unified-audio-system.js.map