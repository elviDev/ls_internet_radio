...
import { CalendarIcon, CheckCircle2, Mail, MapPin, MessageSquare, Phone } from "lucide-react"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
        <Card>
          <CardContent className="p-6 flex flex-col items-center text-center">
            <div className="rounded-full bg-purple-100 dark:bg-purple-900 p-3 w-14 h-14 flex items-center justify-center mb-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="appointment-email" type="email" placeholder="john.doe@example.com" required />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="appointment-notes" placeholder="Any specific details about your appointment..." />
                </div>
                ...
                {formSubmitted && (
                  <div className="flex items-center gap-2 p-3 bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400 rounded-md">
                    <CheckCircle2 className="h-5 w-5" />
                    <span>Your appointment request has been submitted! We'll confirm shortly.</span>
                  </div>
                )}
              </form>
            </TabsContent>
            ...
            <TabsContent value="advertise">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <RadioGroup defaultValue="podcast" className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {formSubmitted && (
                  <div className="flex items-center gap-2 p-3 bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400 rounded-md">
                    <CheckCircle2 className="h-5 w-5" />
                    <span>Your advertising inquiry has been received! Our team will contact you soon.</span>
                  </div>
                )}
              </form>
            </TabsContent>
        ...
        <div>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold mb-2">How can I listen to WaveStream?</h3>
              <p className="text-muted-foreground">
                You can listen to WaveStream directly through our website or by installing our progressive web app on
                your mobile device. We're also available on major podcast platforms.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-2">How do I submit my podcast to WaveStream?</h3>
              <p className="text-muted-foreground">
                We're always looking for great content! Please use the contact form and select "Partnership Opportunity"
                as the subject to submit your podcast for consideration.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-2">Do you offer studio rentals?</h3>
              <p className="text-muted-foreground">
                Yes, our professional recording studios are available for rent. Please book an appointment to discuss
                your needs and schedule a tour.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-2">How can I advertise on WaveStream?</h3>
              <p className="text-muted-foreground">
                We offer various advertising options including podcast sponsorships, live broadcast ads, and digital
                promotions. Use our advertising form to get started.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-2">Are there job opportunities at WaveStream?</h3>
              <p className="text-muted-foreground">
                We're growing! Check our About page for current job openings or send your resume to
                careers@wavestream.example.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 p-6 bg-muted rounded-xl">
            <div className="flex items-start gap-4">
              <div className="rounded-full bg-purple-100 dark:bg-purple-900 p-2 mt-1">
