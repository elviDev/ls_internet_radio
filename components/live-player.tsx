...
import { Play, Pause, Volume2, VolumeX, Calendar, AlertCircle } from "lucide-react"
...
export default function LivePlayer() {
  ...
  // Schedule data
  const schedule = [
    { time: "06:00 - 09:00", show: "Morning Vibes", host: "Alex Rivera", day: "Weekdays" },
    { time: "09:00 - 11:00", show: "Tech Talk", host: "Sarah Johnson", day: "Weekdays" },
    { time: "11:00 - 13:00", show: "Lunch Beats", host: "DJ Marcus", day: "Weekdays" },
    { time: "13:00 - 15:00", show: "Afternoon Acoustics", host: "Mia Chen", day: "Weekdays" },
    { time: "15:00 - 17:00", show: "Business Hour", host: "James Wilson", day: "Weekdays" },
    { time: "17:00 - 19:00", show: "Drive Time", host: "Elena Rodriguez", day: "Weekdays" },
    { time: "19:00 - 21:00", show: "Evening Discussions", host: "Jordan Taylor", day: "Mon, Wed, Fri" },
    { time: "21:00 - 00:00", show: "Night Waves", host: "DJ Luna", day: "Weekdays" },
    { time: "10:00 - 12:00", show: "Weekend Brunch", host: "Chris & Pat", day: "Weekends" },
    { time: "12:00 - 15:00", show: "Sports Central", host: "Mike Thompson", day: "Weekends" },
    { time: "15:00 - 18:00", show: "Cultural Corner", host: "Sophia Lee", day: "Weekends" },
    { time: "18:00 - 22:00", show: "Saturday Night Mix", host: "DJ Pulse", day: "Saturday" },
    { time: "18:00 - 22:00", show: "Sunday Slowdown", host: "Olivia Green", day: "Sunday" },
  ]
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <Button
              ...
              size="icon"
              disabled={isLoading}
              className="w-10 h-10 rounded-full bg-purple-100 hover:bg-purple-200 text-purple-700 dark:bg-purple-900 dark:hover:bg-purple-800 dark:text-purple-200"
            >
              {isLoading ? (
                <div className="h-5 w-5 border-2 border-purple-700 border-t-transparent rounded-full animate-spin" />
              ) : isPlaying ? (
          ...
          <div className="flex items-center">
                ...
                {[...Array(5)].map((_, i) => (
                  <div
                    ...
                    style={{
                      ...
                      height: `${isPlaying ? 10 + Math.floor(Math.random() * 15) : 5}px`,
                    }}
                  ></div>
                ))}
              </div>
            ...
            <Sheet>
              <SheetTrigger asChild>
                <Button variant="link" className="text-purple-600 ml-4">
                ...
                <ScrollArea className="h-full py-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
                    <div>
                      ...
                      <h3 className="font-semibold text-lg mt-6 mb-4">Special Shows</h3>
                      <div className="space-y-3">
                        {schedule
                          .filter((item) => !["Weekdays", "Weekends", "Saturday", "Sunday"].includes(item.day))
                          .map((item, index) => (
                            <div key={index} className="flex justify-between p-3 rounded-lg bg-muted">
                              <div>
                                <p className="font-medium">{item.show}</p>
                    ...
                    <div>
                      ...
                      <h3 className="font-semibold text-lg mt-6 mb-4">Saturday</h3>
                      <div className="space-y-3">
                        {schedule
                      ...
                      <h3 className="font-semibold text-lg mt-6 mb-4">Sunday</h3>
                      <div className="space-y-3">
                        {schedule
